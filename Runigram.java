...
public class Runigram {
	...
	private static Color luminance(Color pixel) {
		...
		Color greyPix = new Color(lum, lum, lum);
		return greyPix;
	}
	...
	public static Color[][] grayScaled(Color[][] image) {
		...
		for (int i = 0; i < greyIm.length; i++) {
			for (int j = 0; j < greyIm[0].length; j++) {
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
				scaledIm[i][j] = image[(int) (i * hRatio)][(int) (j * wRatio)];
			}
		}
		return scaledIm;
	}
	...
	public static Color blend(Color c1, Color c2, double alpha) {
		int red = (int) ((double) alpha * c1.getRed() + (1 - alpha) * c2.getRed());
		int green = (int) ((double) alpha * c1.getGreen() + (1 - alpha) * c2.getGreen());
		int blue = (int) ((double) alpha * c1.getBlue() + (1 - alpha) * c2.getBlue());
	...
	public static Color[][] blend(Color[][] image1, Color[][] image2, double alpha) {
		...
		for (int i = 0; i < blendedIm.length; i++) {
			for (int j = 0; j < blendedIm[0].length; j++) {
